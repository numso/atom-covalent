...
var AtomAdapter = module.exports = function (firepad) {
  ...
  function AtomAdapter(atom) {
    ...
    this.changeListener = this.atom.buffer.onDidChange(this.onChange);
  ...
  AtomAdapter.prototype.setOtherCursor = function(cursor, color, clientId) {
    foreignManager(this.atom, cursor, color, clientId);
  };
